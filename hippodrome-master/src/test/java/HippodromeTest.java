...
class HippodromeTest {
    ...
    void getHorses_ReturnsListWithAllHorsesInOrder() {
        ...
        assertEquals(50, hippodrome.getHorses().size());
    ...
    void getWinner_ReturnsCorrectWinner() {
        Hippodrome hippodrome = new Hippodrome(List.of(new Horse("horse10", 1, 10), new Horse("horse20", 1, 20), new Horse("horse30", 1, 30)));
